...
<DropCapP>
  If you are new to JavaScript, you might not be aware that there are multiple versions of the
  language. That may not seem like a big deal, almost everything on computers is versioned, after
  all. Your computer and phone update to new versions all the time and not much seems to change,
  right?
</DropCapP>

JavaScripts versions are a bigger deal. And, it's not necessarily obvious why. Let's get into it!
...
Programming languages evolve over time. Developers fix bugs, optimize and add new features. This is a good thing. The new features can make your life as a developer much easier.
...
<Block>
  People use two different names to refer to the editions of JavaScript. For example, ES6 and
  ECMA2015 refer to the same versions. I'll stick with the latter since I think the year it was
  adopted is useful context. <a href="https://www.w3schools.com/js/js_versions.asp">w3schools</a>{' '}
  has a great table summarizing the editions.
</Block>

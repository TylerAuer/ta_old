...
![Aggregate ratings on the Matrix](/imgs-for-posts/fruit-matrix-aggregate.png)
...
<img
  ...
  src="/imgs-for-posts/fruit-matrix-notes.jpg"
  alt="Early notes for the Fruit Matrix"
/>{' '}
...
[^1]: It's way more complex than that, but the important thing to realize is that when the browser window changes size the value used to refer to an element's position also changes.

...
const Home: React.FC<PageProps> = ({ data }) => {
  ...
  const featuredAdventurePosts = posts.filter(
    (post) => post.fields.blog === 'code',
  );
      ...
      <main>
        <section id="about">
          <SetWidth>
            ...
            <p>
              After teaching math for twelve years, I taught myself to code. Now
              I build systems to help developers at{' '}
              <a href="nextdoor.com">Nextdoor</a> move fast. I also enjoy
        ...
        <section id="projects">
          <SetWidth>
            ...
            <p>
              ...
              community pot and the winner selects a charity to donate the pot
              to. In 2021 we donated $1,568 to the Pancreatic Cancer Action
              Network! <Link to="/">Sign up</Link> to play next year; donations
              optional.
            </p>
          </SetWidth>
        </section>
